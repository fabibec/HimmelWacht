...
const uint8_t low_battery_blinking_freq_hz = 1; // 1 Hz = 1 Blinks per second
const uint32_t low_battery_blinking_interval_us = 1000000 / low_battery_blinking_freq_hz;
