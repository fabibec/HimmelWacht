...
% Main Content
\input{src/wohlrab/projektplanung.tex}

\input{src/wohlrab/vorbereitungen.tex}

\input{src/koch/stromversorgung.tex}
\input{src/wohlrab/stromversorgung.tex}
...
\input{src/wohlrab/i2c.tex}
\input{src/koch/raspberry.tex}
\input{src/wohlrab/ultraschall.tex}

\input{src/juergens/ai_model.tex}
\input{src/juergens/webrtc.tex}
\input{src/juergens/objekttracking.tex}

\input{src/koch/webserver.tex}
%\input{gnn}
%\input{p5p}
%\input{end.tex}
...
\includepdf[pages=-]{pdfs/Stundenliste_Jonathan_Wohlrab.pdf}
