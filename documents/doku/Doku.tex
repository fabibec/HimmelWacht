...
% Title Page
% \input{cover.tex}
% \includepdf[pages=-]{signed_cover_flattened.pdf}
...
% Time tables
% \includepdf[pages=-]{StundenlisteFabi.pdf}
% \includepdf[pages=-]{StundenlisteNico.pdf}
% \includepdf[pages=-]{StundenlisteJendrik.pdf}
% \includepdf[pages=-]{StundenlisteMichi.pdf}
% \includepdf[pages=-]{StundenlisteJonathan.pdf}
